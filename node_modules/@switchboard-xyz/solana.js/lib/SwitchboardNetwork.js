import { AggregatorAccount, BufferRelayerAccount, CrankAccount, JobAccount, LeaseAccount, OracleAccount, PermissionAccount, ProgramStateAccount, QueueAccount, VrfAccount, } from "./accounts/index.js";
import { AggregatorAccountData, BufferRelayerAccountData, CrankAccountData, JobAccountData, LeaseAccountData, OracleAccountData, OracleQueueAccountData, PermissionAccountData, SbState, VrfAccountData, } from "./generated/index.js";
...
export class SwitchboardNetwork {
   ...
   */
    static async createInstructions(program, payer, params) {
        ...
        // create a new queue
        const [queueAccount, queueInit] = await QueueAccount.createInstructions(program, payer, {
            ...params,

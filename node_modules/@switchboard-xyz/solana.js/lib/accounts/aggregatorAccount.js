...
export class AggregatorAccount extends Account {
    ...
    get slidingWindowKey() {
        return PublicKey.findProgramAddressSync([Buffer.from("SlidingResultAccountData"), this.publicKey.toBytes()], this.program.oracleProgramId)[0];
    }
    ...
    async loadJobs(aggregator) {
        ...
        return await Promise.all(jobAccountDatas.map(async (j) => {
            ...
            const jobState = JobAccountData.decode(j.account.data);
            return {
                account: jobAccount,
                state: jobState,

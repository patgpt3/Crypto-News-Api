...
exports.walletFund = exports.layout = void 0;
...
exports.layout = borsh.struct([types.WalletFundParams.layout("params")]);
function walletFund(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [

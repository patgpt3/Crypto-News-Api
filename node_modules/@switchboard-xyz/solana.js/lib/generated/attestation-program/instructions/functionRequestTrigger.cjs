...
exports.functionRequestTrigger = exports.layout = void 0;
...
function functionRequestTrigger(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.functionRequestTrigger = functionRequestTrigger;

...
exports.functionSetEscrow = exports.layout = void 0;
...
function functionSetEscrow(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.functionSetEscrow = functionSetEscrow;

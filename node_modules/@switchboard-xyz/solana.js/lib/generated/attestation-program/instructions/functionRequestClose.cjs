...
exports.functionRequestClose = exports.layout = void 0;
...
function functionRequestClose(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.functionRequestClose = functionRequestClose;

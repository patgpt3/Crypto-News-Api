...
exports.attestationPermissionSet = exports.layout = void 0;
...
function attestationPermissionSet(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.attestationPermissionSet = attestationPermissionSet;

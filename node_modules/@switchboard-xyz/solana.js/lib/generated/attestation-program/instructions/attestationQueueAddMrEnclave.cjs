...
exports.attestationQueueAddMrEnclave = exports.layout = void 0;
...
function attestationQueueAddMrEnclave(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.attestationQueueAddMrEnclave = attestationQueueAddMrEnclave;

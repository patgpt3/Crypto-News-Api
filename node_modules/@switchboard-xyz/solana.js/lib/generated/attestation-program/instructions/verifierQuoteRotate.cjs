...
exports.verifierQuoteRotate = exports.layout = void 0;
...
function verifierQuoteRotate(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.verifierQuoteRotate = verifierQuoteRotate;

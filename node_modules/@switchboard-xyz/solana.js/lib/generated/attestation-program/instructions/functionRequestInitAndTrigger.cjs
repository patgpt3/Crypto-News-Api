...
exports.functionRequestInitAndTrigger = exports.layout = void 0;
...
function functionRequestInitAndTrigger(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
    ...
    const len = exports.layout.encode({
        params: types.FunctionRequestInitAndTriggerParams.toEncodable(args.params),
    }, buffer);
    const data = Buffer.concat([identifier, buffer]).slice(0, 8 + len);
    const ix = new web3_js_1.TransactionInstruction({ keys, programId, data });
    return ix;
}
exports.functionRequestInitAndTrigger = functionRequestInitAndTrigger;

...
exports.functionRoutineVerify = exports.layout = void 0;
 ...
 *
 */
function functionRoutineVerify(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.functionRoutineVerify = functionRoutineVerify;

...
exports.attestationPermissionInit = exports.layout = void 0;
...
function attestationPermissionInit(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.attestationPermissionInit = attestationPermissionInit;

...
exports.functionSetConfig = exports.layout = void 0;
...
function functionSetConfig(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.functionSetConfig = functionSetConfig;

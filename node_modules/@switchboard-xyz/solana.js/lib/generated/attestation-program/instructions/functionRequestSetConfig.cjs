...
exports.functionRequestSetConfig = exports.layout = void 0;
...
function functionRequestSetConfig(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.functionRequestSetConfig = functionRequestSetConfig;

...
exports.verifierHeartbeat = exports.layout = void 0;
...
function verifierHeartbeat(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.verifierHeartbeat = verifierHeartbeat;

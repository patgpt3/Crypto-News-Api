...
exports.verifierInit = exports.layout = void 0;
...
exports.layout = borsh.struct([types.VerifierInitParams.layout("params")]);
function verifierInit(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.verifierInit = verifierInit;

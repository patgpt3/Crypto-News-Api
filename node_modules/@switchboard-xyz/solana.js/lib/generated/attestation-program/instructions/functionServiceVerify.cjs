...
exports.functionServiceVerify = exports.layout = void 0;
...
function functionServiceVerify(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.functionServiceVerify = functionServiceVerify;

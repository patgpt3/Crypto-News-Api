...
exports.functionResetEscrow = exports.layout = void 0;
...
function functionResetEscrow(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.functionResetEscrow = functionResetEscrow;

...
exports.verifierQuoteVerify = exports.layout = void 0;
...
function verifierQuoteVerify(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.verifierQuoteVerify = verifierQuoteVerify;

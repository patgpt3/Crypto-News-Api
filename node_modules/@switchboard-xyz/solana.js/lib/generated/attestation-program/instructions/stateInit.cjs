...
exports.stateInit = exports.layout = void 0;
...
exports.layout = borsh.struct([types.StateInitParams.layout("params")]);
function stateInit(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [

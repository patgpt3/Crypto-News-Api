...
exports.functionRoutineSetConfig = exports.layout = void 0;
...
function functionRoutineSetConfig(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.functionRoutineSetConfig = functionRoutineSetConfig;

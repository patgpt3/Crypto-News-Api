...
exports.functionRoutineInit = exports.layout = void 0;
 ...
 */
function functionRoutineInit(program, args, accounts, programId = program.attestationProgramId) {
    const keys = [
...
exports.functionRoutineInit = functionRoutineInit;

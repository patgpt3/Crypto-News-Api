...
exports.FunctionRoutineAccountData = void 0;
 ...
 */
class FunctionRoutineAccountData {
    ...
    static fromJSON(obj) {
        return new FunctionRoutineAccountData({
            ...
            lastSuccessfulExecutionTimestamp: new common_1.BN(obj.lastSuccessfulExecutionTimestamp),
            nextAllowedTimestamp: new common_1.BN(obj.nextAllowedTimestamp),
            ebuf: obj.ebuf,
        });
    }
}
exports.FunctionRoutineAccountData = FunctionRoutineAccountData;

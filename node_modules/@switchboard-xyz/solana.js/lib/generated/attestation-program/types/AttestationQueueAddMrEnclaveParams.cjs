...
exports.AttestationQueueAddMrEnclaveParams = void 0;
const borsh = __importStar(require("@coral-xyz/borsh"));
class AttestationQueueAddMrEnclaveParams {
    mrEnclave;
    constructor(fields) {
...
exports.AttestationQueueAddMrEnclaveParams = AttestationQueueAddMrEnclaveParams;

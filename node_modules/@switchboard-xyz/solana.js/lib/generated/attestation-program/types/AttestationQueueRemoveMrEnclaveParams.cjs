...
exports.AttestationQueueRemoveMrEnclaveParams = void 0;
const borsh = __importStar(require("@coral-xyz/borsh"));
class AttestationQueueRemoveMrEnclaveParams {
    mrEnclave;
    constructor(fields) {
...
exports.AttestationQueueRemoveMrEnclaveParams = AttestationQueueRemoveMrEnclaveParams;
